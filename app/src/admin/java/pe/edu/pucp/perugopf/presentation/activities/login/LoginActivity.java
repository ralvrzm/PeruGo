...
import pe.edu.pucp.perugopf.presentation.activities.admin_events_firestore.AdminEventsFirestoreActivity;
...
public class LoginActivity extends BaseActivity implements ILoginContract.IView{
    ...
    public void goToEvents() {
        Intent intent = new Intent(getApplicationContext() , AdminEventsFirestoreActivity.class);
