...
public class CreateEventFirestoreActivity extends BaseActivity implements ICreateEventFirestoreContract.IView {
    ...
    private static final String ESTADO_CREADO = "0";
    ...
    protected int getContentView() {
        return R.layout.activity_create_event_firestore;
    }
    ...
    protected void onViewReady(Bundle savedInstanceState, Intent intent) {
        ...
        btnSave.setOnClickListener(v -> {
            ...
            presenter.createEvent(title, content, currentPhotoPath, direccion, fecha, latitud, longitud, ESTADO_CREADO);
        });
